...
export type SubmittalAssignee = { id: string; name: string | null };

type SubmittalAssigneePopoverProps = {
  workspaceId: string;
  assignee: SubmittalAssignee | null;
  onChange: (userId: string | null) => void;
  children: React.ReactNode;
};

export default function SubmittalAssigneePopover({
  workspaceId,
  assignee,
  onChange,
  children,
}: SubmittalAssigneePopoverProps) {
