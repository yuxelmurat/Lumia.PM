...
export type RfiAssignee = { id: string; name: string | null };

type RfiAssigneePopoverProps = {
  workspaceId: string;
  assignee: RfiAssignee | null;
  onChange: (userId: string | null) => void;
  children: React.ReactNode;
};

export default function RfiAssigneePopover({
  workspaceId,
  assignee,
  onChange,
  children,
}: RfiAssigneePopoverProps) {
      ...
      <PopoverContent className="w-56 p-1" align="start">
        <div className="max-h-64 space-y-1 overflow-y-auto">
          ...
          >
            ...
            <span className="text-sm">{t("rfi:unassigned", "Unassigned")}</span>
