...
const CAPABILITIES = {
  ...
  manageRfis: { rfi: ["update"] },
  manageChangeOrders: { changeOrder: ["update"] },
  manageSubmittals: { submittal: ["update"] },
  managePermits: { permit: ["update"] },
...
export function useWorkspacePermission() {
  ...
  const helpers = useMemo(() => {
    return {
      ...
      canManageRfis: () => can.manageRfis,
      canManageChangeOrders: () => can.manageChangeOrders,
      canManageSubmittals: () => can.manageSubmittals,
      canManagePermits: () => can.managePermits,
