...
export const metadata: Metadata = {
  ...
  description:
    "Lumia.PM is an open-source, self-hostable project management tool, a simple Trello alternative you can run yourself or use as a managed cloud. Free to self-host, fair cloud pricing.",
